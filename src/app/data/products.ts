...
export const products: Product[] = [
  ...
  // Men's Products
  {
    ...
    name: 'SHORT HOMME',
    price: 39.000,
    image: 'https://images.unsplash.com/photo-1617635568529-a9a36c1f85fa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
    category: 'men',
    colors: ['#1a1a1a', '#2d3748', '#4a5568'],
    sizes: ['S', 'M', 'L', 'XL'],
  },
  {
    ...
    price: 59.000,
    image: 'https://images.unsplash.com/photo-1597332053904-a378a4bee3e1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
    category: 'men',
    colors: ['#1a1a1a', '#2d3748'],
    sizes: ['S', 'M', 'L', 'XL'],
  },
  ...
  },
  {
    ...
    price: 49.000,
    image: 'https://images.unsplash.com/photo-1618359747685-cd0fb9d1ab43?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
    category: 'men',
    colors: ['#ffffff', '#1a1a1a', '#4a5568'],
    sizes: ['S', 'M', 'L', 'XL'],
  },
